...
class OCRService:
    ...
    def __init__(self):
        ...
        # Thread pool for visualization (CPU-bound but PIL-safe)
    ...
    async def recognize(
        ...
        def process():
            ...
            for prediction in predictions:
                text_results.append([
                    TextLine(
                        ...
                        polygon=line.polygon if return_coordinate else None,
                        bbox=line.bbox if return_coordinate else None
                    )
            ...
            return text_results, visualizations, full_text
